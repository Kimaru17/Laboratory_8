...
public class Elementary {
    ...
    private static String minChanges;
    private static String minIndexChanges;

    public static String getMinChanges() {
        return minChanges;
    }
    public static String getMinIndexChanges() {
        return minIndexChanges;
    }
